  ...
  return (
    <div className="container mx-auto px-4 py-8 w-full">
      ...
      <p className="mb-6 italic">
        There are currently{" "}
        <span className="font-semibold">{filteredPrinters.length}</span>{" "}
      ...
      {filteredPrinters.length === 0 && (
        <div className="rounded-xl bg-light-bg-2 p-8 text-center mb-6">
          ...
          <p className="mt-2 text-light-tx-2">
            Try searching for another name or country.
          </p>
        </div>
      )}
            ...
            <div key={country} className="mb-10">
              <div className="mb-4 flex items-center gap-4">
                <button
                  ...
                  aria-label={
                    collapsedCountries[country] ? "Expand" : "Collapse"
                  }
                  onClick={() =>
