...
export default function Landing() {
    ...
    return (
        <div className="mx-auto w-full max-w-6xl px-4 py-8">
            <h1 className="text-4xl mb-6 font-bold text-center text-dark-ma">
                Printing Legion!
            </h1>
          ...
          all-time stats!
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8 w-full max-w-5xl mx-auto">
                    <div className="bg-light-bg-2 shadow-md p-4 text-center rounded-lg">
                        <h3 className="text-xl font-semibold mb-2 text-light-tx mt-2">
                            Grams printed:
                        </h3>
                    ...
                    <div className="bg-light-bg-2 rounded-lg shadow-md p-6 text-center">
                        <h3 className="text-xl font-semibold mb-2 text-light-tx">
                            Projects printed:
                        </h3>
                        <p className="text-3xl font-bold text-blue-600">
